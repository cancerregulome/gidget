...
def resegmentCNdata(sampleList, segMatrix, dataMatrix,
    ...
    segList, sampleList, newMatrix = resegment._resegmentChromosomes(
        chrNames, data, chr2maxcoord, sampleList, steplength, cutFrac)
...
def loadPlatformMetaData(zString):
    ...
    if (zString == "jhu-usc.edu/humanmethylation450/methylation/" or
        ...
        if (1):
            ...
            metaDataFilename = "/titan/cancerregulome9/workspaces/bioinformatics_references/tcga_platform_genelists/featNames.09jul12.hg19.txt"
            ...
            while not done:
                ...
                metaData[probeID] = (
                    probeID, geneName, chrName, chrPos, chrStrand)
