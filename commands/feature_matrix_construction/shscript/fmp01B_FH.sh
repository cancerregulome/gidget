...
source ${TCGAFMP_ROOT_DIR}/tcga_fmp_util.sh
...
echo " *******************"
	...
	## ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
        ...
        rm -fr parse_FH.$curDate.log
        python $TCGAFMP_ROOT_DIR/main/parseFirehoseStdData.py $tumor $curDate $fhDir $fhSubset >& parse_FH.$curDate.log
...
echo " "
echo " fmp01B_FH script is FINISHED !!! "
echo `date`
echo " "
