...
## mirnFile=/titan/cancerregulome14/TCGAfmp_outputs/skcm/test3/skcm.mirn.tmpData2.tsv
...
~/scripts/transpose /local/sreynold/scratch/pp01 | cut -c-15 >& /local/sreynold/scratch/pp03
~/scripts/transpose /local/sreynold/scratch/pp02 | cut -c-15 >& /local/sreynold/scratch/pp04
...
~/scripts/transpose /local/sreynold/scratch/methFile.g1 | cut -c-15 >& /local/sreynold/scratch/methFile.g2
~/scripts/transpose /local/sreynold/scratch/mirnFile.g1 | cut -c-15 >& /local/sreynold/scratch/mirnFile.g2
