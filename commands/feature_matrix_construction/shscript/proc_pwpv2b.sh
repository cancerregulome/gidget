...
wc -l $d/post_proc_all.short.sort
...
wc -l $d/post_proc_all.short.sort.mapped

echo " and removing pathway features ... "
grep -iv "pathway" $d/post_proc_all.short.sort.mapped | grep -v "	nan	" >& $d/post_proc_all.short.sort.mapped.noPathway
wc -l $d/post_proc_all.short.sort.mapped.noPathway
