        ...
        if ( iNew == 0 ):
            ...
            for iCol in range(numCol):
                if ( newVecs[0][iCol]=="NA" or newVecs[1][iCol]=="NA" ):
                    ...
                    newVecs[iNew][iCol] = 0
                    if ( iNew == 2 ):
                        if ( newVecs[0][iCol]=="LO"  and newVecs[1][iCol]=="LO" ):  newVecs[iNew][iCol] = 1
                    elif ( iNew == 4 ):
                        if ( newVecs[0][iCol]=="LO"  and newVecs[1][iCol]=="HI" ):  newVecs[iNew][iCol] = 1
                    elif ( iNew == 4 ):
                        if ( newVecs[0][iCol]=="HI"  and newVecs[1][iCol]=="LO" ):  newVecs[iNew][iCol] = 1
                    elif ( iNew == 5 ):
                        if ( newVecs[0][iCol]=="HI"  and newVecs[1][iCol]=="HI" ):  newVecs[iNew][iCol] = 1
            ...
            for iCol in range(numCol):
                if ( newVecs[0][iCol]=="NA" or newVecs[1][iCol]=="NA" ):
                    ...
                    if ( newVecs[0][iCol]=="LO" and newVecs[1][iCol]=="LO" ): newVecs[iNew][iCol] = "basal"
                    if ( newVecs[0][iCol]=="HI" and newVecs[1][iCol]=="LO" ): newVecs[iNew][iCol] = "luminal"
                    if ( newVecs[1][iCol]=="HI" ): newVecs[iNew][iCol] = "her2"
