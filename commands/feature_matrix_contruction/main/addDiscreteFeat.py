...
if __name__ == "__main__":
    ...
    for aFeat in featDict.keys():
        ...
        ( rowLabels, tmpMatrix ) = addIndicators.addIndicators4oneFeat ( rowLabels[-1], rowLabels, tmpMatrix )
