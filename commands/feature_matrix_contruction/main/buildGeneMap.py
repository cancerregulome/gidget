...
def mapFeatures2Genes ( dataD, geneInfoDict, synMapDict, geneCoordDict_bySymbol, 
    ...
    for iRow in range(numRow):
        ...
        if ( iRow%100 == 0 ): print " QQ ", iRow, curLabel
        ...
        ## print " curType=<%s>  haveName=%d  haveCoord=%d " % ( curType, haveName, haveCoord )
...
if __name__ == "__main__":
    ...
    annotD = mapFeatures2Genes ( testD, geneInfoDict, synMapDict, geneCoordDict_bySymbol, geneCoordDict_byID, refGeneDict, cytoDict, extra_bp )
