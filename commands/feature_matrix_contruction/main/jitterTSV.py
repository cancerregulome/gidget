...
if __name__ == "__main__":
    ...
    dataTypeList = [ ( "N:GEXP:", "C:SAMP:gexpPlatform", 0.10, "RNASeq", 999999999 ),
    		     ( "N:MIRN:", "C:SAMP:mirnPlatform", 0.10, "RNASeq", 999999999 ),
    		     ( "N:METH:", "C:SAMP:methPlatform", 0.10, "Methyl", 1 ) ]

    ## new as of 27jun13 :
    dataTypeList = [ ( "N:GEXP:", "C:SAMP:gexpPlatform", 0.01, "RNASeq", 999999999 ),
		    ...
		    ## print featName, aTuple
			    ...
			    if ( curVal == NA_VALUE ):
			        ...
			        try:
				        ...
				        newVal = curVal + ( maxJitter * 2 * ( random.random() - 0.5 ) )
				        if ( newVal < 0 ): newVal = abs(newVal)
				        if ( newVal > maxCutoff ): newVal = maxCutoff - (newVal-maxCutoff)
