...
if __name__ == "__main__":
    ...
    topDir = "/titan/cancerregulome14/TCGAfmp_outputs/%s/%s" % ( tumorString, dateString )
    d1 = path.path ( topDir )
    for f1 in d1.files():
    ...
    outFile = "/titan/cancerregulome14/TCGAfmp_outputs/%s/aux/namedLists.forXmlMerge.tsv" % ( tumorString )
    fh = file ( outFile, 'w' )
