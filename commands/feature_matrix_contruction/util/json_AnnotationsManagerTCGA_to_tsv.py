...
def build_tsv_row_generator(annotation_list):
    ...
    for annotation in annotation_list:
        ...
        classification = annotation['annotationCategory']['annotationClassification']['annotationClassificationName']
        ...
        if ('notes' in annotation):
            ...
            # If the annotation has more than one note, there will be an array of objects
