...
#this script looks at 3 OV files.
#examine if there is overlap between patients
...
my $maf_uniprot="/titan/cancerregulome9/workspaces/users/liype/maf_protein/data/" # TODO:FILE_LAYOUT:EXPLICIT
